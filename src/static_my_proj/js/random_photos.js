let randomized = Math.floor(Math.random()*10)
	...
	photoCategories = ['funny','funny-dog','funny-cat','jokes','comedy','clown','hello','namaste','greeting','thinking']
  ...
  .then((apple) => {let syau = apple.results[randomized].urls.full;
    document.querySelector('#hello').setAttribute('src',syau);console.log(syau)})